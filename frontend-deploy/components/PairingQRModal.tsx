...
export function PairingQRModal({ onClose }: PairingQRModalProps) {
  ...
  useEffect(() => {
    ...
    // Pair locally; Firebase handles call signaling after the QR is scanned.
    const payload = JSON.stringify({
      v: 1,
      id: getOrCreateDeviceId(),
      api: API_URL,
      turnUrl: process.env.NEXT_PUBLIC_TURN_URL || undefined,
      turnUsername: process.env.NEXT_PUBLIC_TURN_USERNAME || undefined,
      turnPassword: process.env.NEXT_PUBLIC_TURN_PASSWORD || undefined,
    });
