...
export function SpidermanAvatar({ emotion, size = 320 }: SpidermanAvatarProps) {
  ...
  return (
    ...
    >
      <svg width={size} height={size*1.15} viewBox="0 0 200 230" fill="none">
        <defs>
          {/* Suit gradients */}
          <radialGradient id="redG" cx="38%" cy="28%" r="68%">
            <stop offset="0%" stopColor="#FFB3B3"/>
            <stop offset="20%" stopColor="#FF5A5A"/>
            <stop offset="45%" stopColor="#E10000"/>
            <stop offset="78%" stopColor="#B10000"/>
            <stop offset="100%" stopColor="#560000"/>
          </radialGradient>
          <radialGradient id="blueG" cx="40%" cy="28%" r="70%">
            <stop offset="0%" stopColor="#A3C9FF"/>
            <stop offset="30%" stopColor="#4A88FF"/>
            <stop offset="65%" stopColor="#1B3E90"/>
            <stop offset="100%" stopColor="#071A39"/>
          </radialGradient>
          <radialGradient id="headG" cx="40%" cy="22%" r="72%">
            <stop offset="0%" stopColor="#FFCECE"/>
            <stop offset="22%" stopColor="#FF4040"/>
            <stop offset="55%" stopColor="#C60303"/>
            <stop offset="100%" stopColor="#5A0000"/>
          </radialGradient>
          {/* Head highlight */}
          <radialGradient id="headSpec" cx="42%" cy="18%" r="30%">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.9"/>
            <stop offset="35%" stopColor="#FFD8D8" stopOpacity="0.24"/>
            <stop offset="100%" stopColor="#FF0000" stopOpacity="0"/>
          </radialGradient>
          <linearGradient id="headContour" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="transparent"/>
            <stop offset="30%" stopColor="#000000" stopOpacity="0.08"/>
            <stop offset="100%" stopColor="#000000" stopOpacity="0.22"/>
          </linearGradient>
          <radialGradient id="eyeGlow" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#FFFFFF" stopOpacity="1"/>
            <stop offset="40%" stopColor="#D6F1FF" stopOpacity="0.95"/>
            <stop offset="100%" stopColor="#8BBEFF" stopOpacity="0.7"/>
          </radialGradient>
          {/* Muscle shading */}
          <radialGradient id="chestShade" cx="50%" cy="40%" r="55%">
            <stop offset="0%" stopColor="white" stopOpacity="0.18"/>
            <stop offset="50%" stopColor="#000000" stopOpacity="0.03"/>
            <stop offset="100%" stopColor="black" stopOpacity="0.28"/>
          </radialGradient>
          <radialGradient id="bodySpec" cx="45%" cy="25%" r="42%">
        ...
        <path d="M 84 118 Q 100 128 116 118 Q 126 136 122 162 Q 112 178 100 180 Q 88 178 78 162 Q 74 136 84 118 Z"
          fill="url(#chestShade)"/>
        {/* Soft 3D chest sheen */}
        <path d="M 86 118 Q 100 126 114 118 Q 122 130 118 154 Q 110 168 100 170 Q 90 166 82 154 Q 78 138 86 118 Z"
          fill="url(#bodySpec)" opacity="0.32"/>
        ...
        />
        {/* Head contour and sheen */}
        <motion.ellipse cx="100" cy="78" rx="38" ry="40"
          fill="url(#headContour)"
          opacity="0.85"
          animate={{ ry: isSurprise?43:40 }}
          transition={{ duration:0.3 }}
        />
        <motion.ellipse cx="92" cy="62" rx="10" ry="8"
          fill="url(#headSpec)" opacity="0.85"
          animate={{ opacity: isTalking?[0.8,0.35,0.8]:0.85 }}
        ...
        {/* ══════════ RIM LIGHTS ══════════ */}
        <path d="M 54 118 Q 80 96 96 90 Q 110 88 118 96 Q 132 118 146 118"
          fill="none" stroke="url(#rimLight)" strokeWidth="5" opacity="0.16"/>
        <path d="M 54 128 Q 80 108 96 102 Q 110 100 118 108 Q 132 128 146 128"
          fill="none" stroke="url(#rimLight)" strokeWidth="4" opacity="0.12"/>
